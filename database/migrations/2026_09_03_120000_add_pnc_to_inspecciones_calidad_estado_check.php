...
return new class extends Migration
{
    ...
    {
        try {
            // Actualizar la restricción CHECK en PostgreSQL/MySQL para permitir los estados 'OBSERVADO' y 'PNC'
    ...
    public function down(): void
    {
        try {
            DB::statement("ALTER TABLE inspecciones_calidad DROP CONSTRAINT IF EXISTS inspecciones_calidad_estado_evaluacion_check;");
            DB::statement("ALTER TABLE inspecciones_calidad ADD CONSTRAINT inspecciones_calidad_estado_evaluacion_check CHECK (estado_evaluacion IN ('CONFORME', 'OBSERVADO_PNC'));");
        } catch (\Throwable $e) {
